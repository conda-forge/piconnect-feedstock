...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/piconnect-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13636&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/piconnect-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `piconnect` can be installed with:

```
conda install piconnect
```

It is possible to list all of the versions of `piconnect` available on your platform with:
